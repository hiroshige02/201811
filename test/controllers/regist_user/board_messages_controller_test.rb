...
class RegistUser::BoardMessagesControllerTest < ActionDispatch::IntegrationTest
  setup do
  ...
  test "should create board_message" do
    assert_difference('BoardMessage.count') do
      post board_messages_url, params: { board_message: { body: @board_message.body, receive_user_id: @board_message.receive_user_id, send_user_id: @board_message.send_user_id } }
    end
  ...
  test "should update board_message" do
    patch board_message_url(@board_message), params: { board_message: { body: @board_message.body, receive_user_id: @board_message.receive_user_id, send_user_id: @board_message.send_user_id } }
